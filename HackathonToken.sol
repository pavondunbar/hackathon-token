...
contract Artemis is ERC20, Ownable, ReentrancyGuard, ERC20Permit, ERC20Votes {
    ...
    constructor(address _usdc, address _treasuryAddress) public ERC20("Artemis", "ART") ERC20Permit("Artemis") Ownable() ReentrancyGuard() {
     ...
     ///////////////////////////////////////////////////////////////////////////////////////////////////////
    /// This part of the contract starts the KYC verification process before any functions can be used. ///
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    mapping(address => KYC) public kycMapping;

    modifier kycVerified(address user) {
      require(bytes(kycMapping[user].id).length != 0, 'KYC Not Verified');
      _;
    }

    function addKYC(address user, string memory id, string memory name, string memory streetAddress, string memory city, string memory state, string memory zip, string memory dob, string memory license, string memory licenseState) public {
      KYC memory kyc = KYC(id, name, streetAddress, city, state, zip, dob, license, licenseState);
      kycMapping[user] = kyc;
    }
    
    // The below example shows how to implement KYC Verification before a function can be executed.

    // function myFunction() public kycVerified(msg.sender) {
      // Only KYC-verified users can access this function
    // }

     ////////////////////////////////////////////////////////////////////////////////////////////////////
    // This is the end of the KYC Verification process. For all functions that need KYC Verification, //
   // add the kycVerified(msg.sender) in the function before the open curly brackets like above.     //
  ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function buy(uint _amount, address _referer ) public kycVerified(msg.sender) nonReentrant() {
        uint Tf = 0;
        uint Tref = 0 ;      
